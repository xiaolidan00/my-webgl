...
onload = function () {
  ...
  var eLaplacianGray = document.getElementById('laplacianGray');
  ...
  oUniLocation[2] = gl.getUniformLocation(oPrg, 'laplacian');
  oUniLocation[3] = gl.getUniformLocation(oPrg, 'laplacianGray');
  oUniLocation[4] = gl.getUniformLocation(oPrg, 'coef');
  ...
  // laplacianフィルタのカーネル
  var coef = [1.0, 1.0, 1.0, 1.0, -8.0, 1.0, 1.0, 1.0, 1.0];
  ...
  (function () {
    ...
    var laplacian = !eColor.checked;
    var laplacianGray = eLaplacianGray.checked;
    ...
    gl.uniform1i(oUniLocation[2], laplacian);
    gl.uniform1i(oUniLocation[3], laplacianGray);
    gl.uniform1fv(oUniLocation[4], coef);
